...
module acquisition_serial_hls_deadlock_idx2_monitor ( // for module acquisition_serial_acquisition_serial_inst.grp_load_inputs_once_fu_283.grp_capture_inputs_to_mem_fu_128
    input wire clock,
    input wire reset,
...
// instant sub module
 acquisition_serial_hls_deadlock_idx3_monitor acquisition_serial_hls_deadlock_idx3_monitor_U (
    .clock(clock),
    .reset(reset),
