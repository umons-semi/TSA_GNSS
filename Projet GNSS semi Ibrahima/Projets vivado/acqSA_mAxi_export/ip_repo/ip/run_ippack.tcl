...
set Library     "hls"
set IPName      "acquisition_serial_m_axi"
set Version     "1.0"
set DisplayName "Acquisition_serial_m_axi"
set Revision    "2114569784"
...
set xo_kernel_name "acquisition_serial_m_axi"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/LABO01/PYNQ/Ibrahima_1/Vitis/acqDMA/acq_serial_dtf_m_axi/acq_serial_dtf_m_axi/hls"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/Users/LABO01/PYNQ/Ibrahima_1/Vitis/acqDMA/acq_serial_dtf_m_axi/acq_serial_dtf_m_axi/hls/.debug"
set xo_hls_files_dir ""
set hdl_module_list {acquisition_serial_m_axi_flow_control_loop_pipe_sequential_init
acquisition_serial_m_axi_flow_control_loop_pipe
acquisition_serial_m_axi_fifo_w2_d64_S
acquisition_serial_m_axi_fifo_w1_d64_S
acquisition_serial_m_axi_start_for_store_stream_to_mem_U0
acquisition_serial_m_axi_flow_control_loop_pipe_sequential_init
...
acquisition_serial_m_axi_flow_control_loop_pipe_sequential_init
acquisition_serial_m_axi_fifo_w64_d3_S
acquisition_serial_m_axi_fifo_w1_d3_S
acquisition_serial_m_axi_fifo_w1_d3_S
acquisition_serial_m_axi_fifo_w128_d64_A
acquisition_serial_m_axi_fifo_w15_d2_S
acquisition_serial_m_axi_start_for_reduce_all_powers_U0
...
read_inputs_to_stream_m_axi_Pipeline_READ_INPUTS
read_inputs_to_stream_m_axi
store_stream_to_mem
capture_inputs_to_mem_m_axi
load_inputs_once
build_prn_banks
entry_proc
doppler_mixer_to_mem_Pipeline_MIX_ALL
doppler_mixer_to_mem
process_tau_tile_v9_Pipeline_SAMPLE_LOOP
process_tau_tile_v9_Pipeline_OUTPUT_TILE
process_tau_tile_v9
process_tau_df_v9
process_one_fd
produce_all_fd_powers
reduce_all_powers_Pipeline_REDUCE_ALL
reduce_all_powers
run_fd_dataflow_region
acquisition_serial_m_axi
}
set kernel_xo ""
set detect_deadlock_json "acquisition_serial_m_axi_message_dict.json"

## Variables
set Top "acquisition_serial_m_axi"
set TopNoPrefix "acquisition_serial_m_axi"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 rx_real_1 W 0x0 "Data signal of rx_real" {{0 32 rx_real W 0 "Bit 31 to 0 of rx_real"}}} {0x14 rx_real_2 W 0x0 "Data signal of rx_real" {{0 32 rx_real W 0 "Bit 63 to 32 of rx_real"}}} {0x1c prn_in_1 W 0x0 "Data signal of prn_in" {{0 32 prn_in W 0 "Bit 31 to 0 of prn_in"}}} {0x20 prn_in_2 W 0x0 "Data signal of prn_in" {{0 32 prn_in W 0 "Bit 63 to 32 of prn_in"}}} {0x28 corr_out_1 W 0x0 "Data signal of corr_out" {{0 32 corr_out W 0 "Bit 31 to 0 of corr_out"}}} {0x2c corr_out_2 W 0x0 "Data signal of corr_out" {{0 32 corr_out W 0 "Bit 63 to 32 of corr_out"}}} {0x34 corr_count R 0x0 "Data signal of corr_count" {{0 32 corr_count R 0 "Bit 31 to 0 of corr_count"}}} {0x38 corr_count_ctrl R 0x0 "Control signal of corr_count" {{0 1 corr_count_ap_vld R 0 "Control signal corr_count_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x44 doppler_out R 0x0 "Data signal of doppler_out" {{0 32 doppler_out R 0 "Bit 31 to 0 of doppler_out"}}} {0x48 doppler_out_ctrl R 0x0 "Control signal of doppler_out" {{0 1 doppler_out_ap_vld R 0 "Control signal doppler_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x54 codephase_out R 0x0 "Data signal of codephase_out" {{0 32 codephase_out R 0 "Bit 31 to 0 of codephase_out"}}} {0x58 codephase_out_ctrl R 0x0 "Control signal of codephase_out" {{0 1 codephase_out_ap_vld R 0 "Control signal codephase_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x64 sat_detected R 0x0 "Data signal of sat_detected" {{0 32 sat_detected R 0 "Bit 31 to 0 of sat_detected"}}} {0x68 sat_detected_ctrl R 0x0 "Control signal of sat_detected" {{0 1 sat_detected_ap_vld R 0 "Control signal sat_detected_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x74 fd_step W 0x0 "Data signal of fd_step" {{0 32 fd_step W 0 "Bit 31 to 0 of fd_step"}}} {0x7c max_power_out R 0x0 "Data signal of max_power_out" {{0 32 max_power_out R 0 "Bit 31 to 0 of max_power_out"}}} {0x80 max_power_out_ctrl R 0x0 "Control signal of max_power_out" {{0 1 max_power_out_ap_vld R 0 "Control signal max_power_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x8c mean_power_out R 0x0 "Data signal of mean_power_out" {{0 32 mean_power_out R 0 "Bit 31 to 0 of mean_power_out"}}} {0x90 mean_power_out_ctrl R 0x0 "Control signal of mean_power_out" {{0 1 mean_power_out_ap_vld R 0 "Control signal mean_power_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x9c rx_count R 0x0 "Data signal of rx_count" {{0 32 rx_count R 0 "Bit 31 to 0 of rx_count"}}} {0xa0 rx_count_ctrl R 0x0 "Control signal of rx_count" {{0 1 rx_count_ap_vld R 0 "Control signal rx_count_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xac prn_count R 0x0 "Data signal of prn_count" {{0 32 prn_count R 0 "Bit 31 to 0 of prn_count"}}} {0xb0 prn_count_ctrl R 0x0 "Control signal of prn_count" {{0 1 prn_count_ap_vld R 0 "Control signal prn_count_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xbc rx_last_seen R 0x0 "Data signal of rx_last_seen" {{0 32 rx_last_seen R 0 "Bit 31 to 0 of rx_last_seen"}}} {0xc0 rx_last_seen_ctrl R 0x0 "Control signal of rx_last_seen" {{0 1 rx_last_seen_ap_vld R 0 "Control signal rx_last_seen_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xcc prn_last_seen R 0x0 "Data signal of prn_last_seen" {{0 32 prn_last_seen R 0 "Bit 31 to 0 of prn_last_seen"}}} {0xd0 prn_last_seen_ctrl R 0x0 "Control signal of prn_last_seen" {{0 1 prn_last_seen_ap_vld R 0 "Control signal prn_last_seen_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xdc rx_last_pos R 0x0 "Data signal of rx_last_pos" {{0 32 rx_last_pos R 0 "Bit 31 to 0 of rx_last_pos"}}} {0xe0 rx_last_pos_ctrl R 0x0 "Control signal of rx_last_pos" {{0 1 rx_last_pos_ap_vld R 0 "Control signal rx_last_pos_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xec prn_last_pos R 0x0 "Data signal of prn_last_pos" {{0 32 prn_last_pos R 0 "Bit 31 to 0 of prn_last_pos"}}} {0xf0 prn_last_pos_ctrl R 0x0 "Control signal of prn_last_pos" {{0 1 prn_last_pos_ap_vld R 0 "Control signal prn_last_pos_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 1598817 II x}
