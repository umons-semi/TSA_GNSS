...
set Library     "hls"
set IPName      "acquisition_stsa_top"
set Version     "1.0"
set DisplayName "Acquisition_stsa_top"
set Revision    "2114597053"
...
set xo_kernel_name "acquisition_stsa_top"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/LABO01/PYNQ/Ibrahima_1/Vitis/acqDMA/acq_stsa_V2/acq_stsa_V2/hls"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/Users/LABO01/PYNQ/Ibrahima_1/Vitis/acqDMA/acq_stsa_V2/acq_stsa_V2/hls/.debug"
set xo_hls_files_dir ""
set hdl_module_list {acquisition_stsa_top_flow_control_loop_pipe
acquisition_stsa_top_flow_control_loop_pipe
acquisition_stsa_top_fifo_w16_d64_S
acquisition_stsa_top_fifo_w16_d64_S
acquisition_stsa_top_start_for_store_stream_to_mem_stsa_U0
acquisition_stsa_top_flow_control_loop_pipe_sequential_init
acquisition_stsa_top_flow_control_loop_pipe_sequential_init
...
acquisition_stsa_top_fifo_w90_d64_S
acquisition_stsa_top_fifo_w8_d2_S
acquisition_stsa_top_fifo_w90_d32_S
acquisition_stsa_top_fifo_w32_d2048_A
acquisition_stsa_top_fifo_w96_d2_S
acquisition_stsa_top_fifo_w8_d2_S
acquisition_stsa_top_start_for_reduce_fine_stream_core_U0
acquisition_stsa_top_start_for_write_corr_out_stream_U0
acquisition_stsa_top_start_for_consume_fine_maxima_and_insert_U0
acquisition_stsa_top_start_for_read_fine_stats_U0
acquisition_stsa_top_flow_control_loop_pipe_sequential_init
acquisition_stsa_top_flow_control_loop_pipe_sequential_init
acquisition_stsa_top_flow_control_loop_pipe_sequential_init
...
acquisition_stsa_top_regslice_both
acquisition_stsa_top_regslice_both
read_inputs_to_stream_stsa
store_stream_to_mem_stsa
capture_inputs_to_mem_stsa
build_prn_variants_Pipeline_BUILD_PRN_BASE
build_prn_variants_Pipeline_DUP_PRN_ALL
build_prn_variants
build_prn_banks_Pipeline_BUILD_BANKS
build_prn_banks
coarse_search_Pipeline_INIT_ACC_TAU
coarse_search_Pipeline_MIX_SUB_PASS
coarse_search_Pipeline_LOAD_ACC_TILE_FULL
coarse_search_Pipeline_SAMPLE_LOOP_COARSE
coarse_search_Pipeline_STORE_ACC_TILE_FULL
coarse_search_Pipeline_VITIS_LOOP_5365_1
select_spaced_topk_Pipeline_INIT_USED
select_spaced_topk_Pipeline_FIND_BEST_UNUSED
select_spaced_topk_Pipeline_CHECK_SEP_LOOP
select_spaced_topk
coarse_search
fine_mix_to_mem_Pipeline_MIX_LOOP
fine_mix_to_mem
process_all_variants_all_tau_Pipeline_SAMPLE_LOOP_ALL
process_all_variants_all_tau_Pipeline_STORE_VARIANT_ALL
process_all_variants_all_tau
produce_fine_powers
reduce_fine_stream_core_Pipeline_REDUCE_TAU
reduce_fine_stream_core
write_corr_out_stream_Pipeline_WRITE_CORR
write_corr_out_stream
consume_fine_maxima_and_insert_Pipeline_INIT_NUM_PEAKS_FS
consume_fine_maxima_and_insert_Pipeline_VITIS_LOOP_5365_1
consume_fine_maxima_and_insert_Pipeline_COPY_NUM_PEAKS_FS_OUT
consume_fine_maxima_and_insert
read_fine_stats
run_fine_dataflow_core
run_fine_dataflow_region
select_spaced_topk_1_Pipeline_INIT_USED
select_spaced_topk_1_Pipeline_FIND_BEST_UNUSED
select_spaced_topk_1_Pipeline_CHECK_SEP_LOOP
select_spaced_topk_1
fine_search
acquisition_stsa
acquisition_stsa_top
}
set kernel_xo ""
set detect_deadlock_json "acquisition_stsa_top_message_dict.json"

## Variables
set Top "acquisition_stsa_top"
set TopNoPrefix "acquisition_stsa_top"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 doppler_out R 0x0 "Data signal of doppler_out" {{0 32 doppler_out R 0 "Bit 31 to 0 of doppler_out"}}} {0x14 doppler_out_ctrl R 0x0 "Control signal of doppler_out" {{0 1 doppler_out_ap_vld R 0 "Control signal doppler_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 phase_out R 0x0 "Data signal of phase_out" {{0 32 phase_out R 0 "Bit 31 to 0 of phase_out"}}} {0x24 phase_out_ctrl R 0x0 "Control signal of phase_out" {{0 1 phase_out_ap_vld R 0 "Control signal phase_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 peak_out_1 R 0x0 "Data signal of peak_out" {{0 32 peak_out R 0 "Bit 31 to 0 of peak_out"}}} {0x34 peak_out_2 R 0x0 "Data signal of peak_out" {{0 16 peak_out R 0 "Bit 47 to 32 of peak_out"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 peak_out_ctrl R 0x0 "Control signal of peak_out" {{0 1 peak_out_ap_vld R 0 "Control signal peak_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 detected_out R 0x0 "Data signal of detected_out" {{0 1 detected_out R 0 "Bit 0 to 0 of detected_out"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x4c detected_out_ctrl R 0x0 "Control signal of detected_out" {{0 1 detected_out_ap_vld R 0 "Control signal detected_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 max_power_out R 0x0 "Data signal of max_power_out" {{0 32 max_power_out R 0 "Bit 31 to 0 of max_power_out"}}} {0x5c max_power_out_ctrl R 0x0 "Control signal of max_power_out" {{0 1 max_power_out_ap_vld R 0 "Control signal max_power_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 mean_power_out R 0x0 "Data signal of mean_power_out" {{0 32 mean_power_out R 0 "Bit 31 to 0 of mean_power_out"}}} {0x6c mean_power_out_ctrl R 0x0 "Control signal of mean_power_out" {{0 1 mean_power_out_ap_vld R 0 "Control signal mean_power_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL rx_stream prn_stream corr_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
